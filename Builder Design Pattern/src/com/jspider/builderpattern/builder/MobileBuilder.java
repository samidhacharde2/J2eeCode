...
public class MobileBuilder {
	...
	public Mobile getMobile() {
		Mobile mobile=new Mobile(this.brand,this.model,this.ram,this.memory,
				this.front_cam,this.rare_cam,this.price,this.battery,this.color,this.processor);
