...
public class StudentService implements StudentServiceInterface {
	...
	@Override
	public StudentDTO searchStudent(int id, String name, String email, String userName, String password) {
		if(id > 0) {
			StudentDTO student = dao.search(id, name, email, userName, password);
			return student;
		}
		return null;
	}
